...
class _AgentVerifyEmailScreenState extends State<AgentVerifyEmailScreen> {
  ...
  void _onCellChanged(String value, int index) {
    ...
    // Support paste: if 6 digits are pasted into the first box
              ...
              builder: (ctrl) => Column(
                children: [
                  ...
                  ctrl.isResending
                      ...
                      : CustomButton(
                          buttonText: ctrl.invalidOtp
                              ? 'Wrong code — Resend OTP'
                              : 'Resend Code',
                          width: screenWidth(context),
                          color: AppColors.plainWhite,
                          borderColor: ctrl.invalidOtp
                              ? AppColors.coolRed
                              : AppColors.primaryThemeColor,
                          textcolor: ctrl.invalidOtp
                              ? AppColors.coolRed
                              : AppColors.primaryThemeColor,
      ...
      child: SizedBox(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            filled: true,
            fillColor: hasError
                ? AppColors.coolRed.withValues(alpha: 0.06)
                : AppColors.primaryThemeColor.withValues(alpha: 0.06),
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(12),
              borderSide: BorderSide(
                color: hasError
                    ? AppColors.coolRed.withValues(alpha: 0.5)
