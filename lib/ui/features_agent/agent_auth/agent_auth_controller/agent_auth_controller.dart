...
// ── Lightweight Sign-In Controller (only what signin screen needs) ──────────
class AgentAuthController extends GetxController {
  ...
  Future<void> resendVerificationEmail() async {
    try {
      ...
      Fluttertoast.showToast(msg: 'Could not send email. Try again later.');
    }
  }

  Future<bool> checkEmailVerified(BuildContext context) async {
...
// ── Signup Controller (only created when signup screen is open) ─────────────
